...
cart.forEach((cartItem) => {
  ...
  matchingProducts=getProducts(productId);

  let matchingDeliveryOptionId=cartItem.deliveryOptionId;
  let matchingTimes=getDeliveryOptions(matchingDeliveryOptionId);
